...
import { Grid, Container, Button, Form, Header, Statistic, Message, Divider, Segment } from 'semantic-ui-react'
		...
		return(
			<Container> 
				...
				<Grid verticalAlign="middle">
					...
					<Grid.Column width={4}>
						<Message hidden={this.state.submitStatus === "success" ? false : true} success header="Floor submitted successfully!" />
						<Message hidden={this.state.submitStatus === "error" ? false : true} error header="A problem occured with submitting."/>
					</Grid.Column>
				</Grid>
			</Container>
		)
